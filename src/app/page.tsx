...
const HomePage = () => {
  ...
  return (
    ...
    >
      <motion.div
        className="marginTop md:w-[43%] w-[80%] border-2 md:border-0 border-blue-500 mt-8 md:mt-0 
      ...
      <div className="flex flex-col md:w-1/2 md:gap-2 gap-4">
        ...
        <motion.span
          className="md:text-3xl md:text-start text-2xl text-center dark:text-blue-300 text-slate-500 font-semibold"
